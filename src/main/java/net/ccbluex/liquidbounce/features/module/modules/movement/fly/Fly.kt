...
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.hypixel.BoostHypixel
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.hypixel.FreeHypixel
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.hypixel.Hypixel
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.ncp.NCP
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.ncp.OldNCP
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.other.*
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.spartan.BugSpartan
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.spartan.Spartan
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.spartan.Spartan2
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.vanilla.SmoothVanilla
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.vanilla.Vanilla
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.verus.Verus
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.verus.VerusGlide
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.vulcan.Vulcan
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.vulcan.VulcanGhost
import net.ccbluex.liquidbounce.features.module.modules.movement.fly.modes.vulcan.VulcanOld
...
object Fly : Module("Fly", Category.MOVEMENT, Keyboard.KEY_F) {
    ...
    val swing by boolean("Swing", true) { mode == "Fireball" }.subjective()
